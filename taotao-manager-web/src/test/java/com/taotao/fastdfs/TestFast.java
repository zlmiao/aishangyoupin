...
public class TestFast {
	...
	public void testupload()throws Exception {
		...
		//2.初始化加载配置文件
		ClientGlobal.init("E:/Java/IdeaProjects/taotao1/taotao-manager-web/src/main/resources/resource/fastdfs.conf");
		//3.创建trackerClient对象
		...
		//第二个参数：文件的扩展名 不带"."
		//第三个参数：元数据     
		String[] upload_file = storageClient.upload_file("C:/Users/zlmiao/Pictures/images/amen.jpg", "jpg", null);
		//8.打印图片的地址 ，测试访问
	...
	public void testFastClient() throws Exception {
		FastDFSClient client = new FastDFSClient("E:/Java/IdeaProjects/taotao1/taotao-manager-web/src/main/resources/resource/fastdfs.conf");
		String uploadFile = client.uploadFile("C:/Users/zlmiao/Pictures/images/xigua.jpg", "jpg");
